/* ============================================================
 * 小站财经渲染（消费 window.NEWS，缩略图用 window.makeThumb）
 * 渲染目标：左栏(导航/日历/外汇/基金) 中栏(头条/要闻/卡片/图集/栏目) 右栏(头条榜/专题)
 * 注：#stock-widget 由 stock.js 渲染，#idx-track / #idx-list 由 market.js 渲染。
 * ============================================================ */
(function () {
  'use strict';
  var N = window.NEWS;
